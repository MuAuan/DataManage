...
"""
このプログラムは、Yahooサイトから一回当たり６０個データ取得して、dataに格納します。
参考　このプログラムは以下のサイトのものをまんま利用
http://karaage.hatenadiary.jp/entry/2017/08/23/073000

乃木坂メンバー;秋元真夏、白石麻衣、西野七瀬、生田絵梨花
欅坂メンバー;
"""
...
fetcher = Fetcher("MY_EMAIL_ADDR") #mail address
